...
![图 1. LASSO 选择路径：5 折平均非零系数随 C 变化（10 特征 pool）。](figures/Figure_v3_01_LASSO_Path.png)
...
![图 2. Temporal-test ROC 曲线（10 特征）。](figures/Figure_v3_02_ROC.png)

![图 3. Temporal-test 精度-召回曲线（10 特征）。](figures/Figure_v3_03_PR.png)

**图 2/3 解读**：ROC 曲线在 temporal test 上 AUC ≈ 0.686, 精度-召回曲线远高于 0.408 的患病率参考线（AP ≈ 0.667）。10 特征模型在 development OOF 与 temporal test 上的性能数字非常接近，说明模型在时间外验证上无明显退化。
...
![图 22. 特征精简方案对比。](figures/Figure_v3_22_Prune_Comparison.png)
