...
1. **"看到病人就先量腺体" —— 腺体重量是预后第一驱动**。Thyroid weight 的 PDP 在两池上都从 0.18（10 g）单调升到 0.94（116 g），覆盖了 NHRH 风险从五分之一到九成的全跨度。一例 174.9 g 巨大腺体的 dev OOF 校准概率 P=0.98，其 SHAP 贡献中 Thyroid weight 一项就 +5.36 logit，其他 8 项加起来约 +0.1 logit。**临床落到一句话："腺体越大，NHRH 风险越大；这条比所有其他治疗前指标加起来都重要"**。这与 GREAT 评分等国际共识一致，但我们的数据把"重要程度"具体化到了"一项压九项"。
